...
void func_800484C8(MF *arg0, MF *arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, f32 arg9, f32 argA)
{
  ...
  sp60 = (unsigned short) temp_f14;
  sp5C = new_var2;
  temp_f18 = arg4 - arg9;
  sp58 = temp_f18;
  temp_len = sqrtf((new_var3 = (temp_f14 * temp_f14) + (new_var2 * new_var2)) + (temp_f18 * temp_f18));
 ...
 temp_f16 = temp_f24 * temp_f2; cross1_x = (argA * temp_f16) - (arg7 * temp_f12); cross1_y = (arg5 * temp_f12) - (argA * temp_f14); cross1_z = (arg7 * temp_f14) - (arg5 * temp_f16); temp_len = sqrtf(((cross1_x * cross1_x) + (cross1_y * cross1_y)) + (cross1_z * cross1_z)); if (temp_len <= 0.0f) { return; } temp_f2 = 1.0f / temp_len; cross1_x *= temp_f2;
  cross1_y *= temp_f2;
  cross1_z *= temp_f2;
