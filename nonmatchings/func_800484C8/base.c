...
void func_800484C8(MF *arg0, MF *arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, f32 arg9, f32 argA)
{
  ...
  f32 final_trans;
  temp_f14 = arg2 - arg8;
  goto dummy_label_912618; dummy_label_912618: ;
  new_var = temp_f16;
  new_var2 = new_var;
  if ((((temp_f14 * temp_f14) + (temp_f16 * ((0, temp_f16)))) + (temp_f18 * temp_f18)) <= 0.0f)
  {
    return;
  }
  sp60 = temp_f14;
  ...
  arg1->yx = (temp_f12 = temp_f22 * temp_f2);
  arg1->xx = (sp48 = temp_f20 * temp_f2);
  cross2_z = arg3;
  arg1->zx = (sp50 = temp_f24 * temp_f2);
  sp3C = (((-arg2) * sp48) + (cross2_z * temp_f12)) - (arg4 * sp50);
  cross1_x = temp_f24;
  cross1_x = (argA * cross1_x) - (arg7 * temp_f22);
  ...
  arg1->zy = sp44;
  temp_f18 = cross1_z;
  cross3_x = (new_var2 * temp_f18) - (temp_f18 * cross1_y);
  ...
  arg1->xz = (temp_f12 = cross3_y * temp_f2);
  arg1->yz = (temp_f14 = cross3_x * temp_f2);
  arg1->zz = (temp_f16 = cross3_z * temp_f2);
