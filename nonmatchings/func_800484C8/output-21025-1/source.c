...
void func_800484C8(MF *arg0, MF *arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, f32 arg9, f32 argA)
{
  ...
  forward.y *= len;
  forward.z *= len;
  side.x = (argA * new_var.z) - (arg7 * new_var.y);
  side.y = (arg7 * new_var.x) - (arg5 * new_var.z);
  side.z = (arg5 * new_var.y) - (argA * new_var.x);
  ...
  side.y *= len;
  side.z *= len;
  up.x = (new_var.y * side.z) - (new_var.z * side.y);
  up.y = (new_var.z * side.x) - (new_var.x * side.z);
  up.z = (new_var.x * side.y) - (new_var.y * side.x);
  arg1->xx = side.x;
  arg1->yx = up.x;
  arg1->zx = -new_var.x;
  arg1->xy = side.y;
  ...
  arg1->zw = ((arg2 * new_var.x) + (arg3 * new_var.y)) + (arg4 * new_var.z);
