...
void func_800484C8(MF *arg0, MF *arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, f32 arg9, f32 argA)
{
  ...
  sp5C = cross1_y;
  temp_len = ((cross1_x * cross1_x) + (sp5C * sp5C)) + (cross1_z * cross1_z);
  if (temp_len <= 0.0f)
  {
    return;
  }
  ...
  arg1->zy = sp44;
  temp_f18 = cross1_z;
  cross3_x = (new_var * temp_f18) - (temp_f18 * sp5C);
  cross3_y = (temp_f18 * cross1_x) - (temp_f14 * cross1_z);
  cross3_z = (temp_f14 * sp5C) - up_y;
