...
void func_800484C8(MF *arg0, MF *arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, f32 arg9, f32 argA)
{
  ...
  up_z = (0, (temp_f14 * cross2_y) - (cross2_x * cross2_x));
  new_var = up_x;
  temp_len = ((new_var * new_var) + (up_y * up_y)) + (up_z * up_z);
  if (temp_len <= 0.0f)
  {
    return;
  }
  ...
  arg1->yz = temp_f14;
  arg1->zz = temp_f16;
  temp_f12 = ((-arg2) * temp_f14) + (arg3 * temp_f12);
  final_trans = temp_f12 - (arg4 * temp_f16);
  new_var2 = (arg1->wx = 0.0f);
  arg1->wz = (arg1->wy = new_var2);
  arg1->ww = 1.0f;
  arg1->xw = final_trans;
