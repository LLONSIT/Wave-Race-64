...
void func_800484C8(MF *arg0, MF *arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7, f32 arg8, f32 arg9, f32 argA)
{
  ...
  sp60 = temp_f14;
  sp5C = new_var;
 do { sp58 = temp_f18; temp_len = sqrtf(temp_len); temp_f2 = 1.0f / temp_len; temp_f22 = new_var; temp_f20 = temp_f14; temp_f24 = temp_f18; temp_f12 = temp_f22 * temp_f2; sp48 = temp_f20 * temp_f2; sp50 = temp_f24 * temp_f2; arg1->yx = temp_f12; arg1->xx = sp48; arg1->zx = sp50; sp3C = (((-arg2) * sp48) + (arg3 * temp_f12)) - (arg4 * sp50); cross1_x = (argA * temp_f24) - (arg7 * temp_f22); cross1_z = (arg8 * temp_f22) - (arg6 * temp_f20); cross2_x = (argA * sp50) - (arg9 * temp_f12); cross2_y = (arg9 * sp48) - (argA * sp50); cross2_z = (arg8 * temp_f12) - (arg6 * sp48); temp_len = ((cross1_x * cross1_x) + (cross1_y * cross1_y)) + (cross1_z * cross1_z); if (temp_len <= 0.0f) { return; } cross2_x = new_var; temp_len = sqrtf(temp_len); temp_f2 = 1.0f / temp_len; temp_f12 = cross1_y * temp_f2; sp3C = cross1_x * temp_f2; sp44 = cross1_z * temp_f2; arg1->xy = temp_f12; arg1->yy = sp3C; arg1->zy = sp44; temp_f18 = cross1_z; } while (0);
