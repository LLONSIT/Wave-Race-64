...
void func_8004A2B4(void)
{
 ...
 ctrl->prevButton = button; ctrl->button = pad->button; ctrl->pressedButton = ctrl->button & (ctrl->button ^ button); ctrl->stick_x = pad->stick_x; ctrl->releasedButton = button & (ctrl->button ^ button); ctrl->stick_y = pad->stick_y;
    }
    controllerMask <<= 1;
  }
