...
glabel osInvalDCache
    ...
    /* 84AFC 800CA2FC BD150000 */  cache      0x15, 0x0($t0) /* handwritten instruction */
  ...
  .L800CA310:
    ...
    /* 84B20 800CA320 BD350010 */  cache      0x15, 0x10($t1) /* handwritten instruction */
    /* 84B24 800CA324 0128082B */  sltu       $at, $t1, $t0
    /* 84B28 800CA328 14200005 */  bnez       $at, .L800CA340
    /* 84B2C 800CA32C 00000000 */   nop
  .L800CA330:
    /* 84B30 800CA330 BD110000 */  cache      0x11, 0x0($t0) /* handwritten instruction */
  ...
  .L800CA354:
    /* 84B54 800CA354 BD010000 */  cache      0x01, 0x0($t0) /* handwritten instruction */
    /* 84B58 800CA358 0109082B */  sltu       $at, $t0, $t1
    /* 84B5C 800CA35C 1420FFFD */  bnez       $at, .L800CA354
    /* 84B60 800CA360 25080010 */   addiu     $t0, $t0, (0x80000010 & 0xFFFF)
