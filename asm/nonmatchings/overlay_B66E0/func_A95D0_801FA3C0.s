glabel func_A95D0_801FA3C0
    ...
    /* C8B08 801FA4D8 3C06800E */  lui        $a2, %hi(D_800DAB28)
    /* C8B0C 801FA4DC 8CC6AB28 */  lw         $a2, %lo(D_800DAB28)($a2)
    /* C8B10 801FA4E0 26100008 */  addiu      $s0, $s0, 0x8
    /* C8B14 801FA4E4 3C05801A */  lui        $a1, %hi(D_801982F0)
    ...
    /* C8B40 801FA510 8CA582F0 */  lw         $a1, %lo(D_801982F0)($a1)
  ...
  .LA95D0_801FA5E4:
    ...
    /* C8C50 801FA620 3C05801A */  lui        $a1, %hi(D_801982F0)
    /* C8C54 801FA624 AC590004 */  sw         $t9, 0x4($v0)
    /* C8C58 801FA628 8CA582F0 */  lw         $a1, %lo(D_801982F0)($a1)
    /* C8C5C 801FA62C 3C06800E */  lui        $a2, %hi(D_800DAB28)
    /* C8C60 801FA630 8CC6AB28 */  lw         $a2, %lo(D_800DAB28)($a2)
  ...
  .LA95D0_801FA660:
    ...
    /* C8DE0 801FA7B0 3C06800E */  lui        $a2, %hi(D_800DAB28)
    /* C8DE4 801FA7B4 8CC6AB28 */  lw         $a2, %lo(D_800DAB28)($a2)
    ...
    /* C8E04 801FA7D4 3C05801A */  lui        $a1, %hi(D_801982F0)
    ...
    /* C8E30 801FA800 8CA582F0 */  lw         $a1, %lo(D_801982F0)($a1)
  .LA95D0_801FA804:
  ...
  .LA95D0_801FA8C8:
    ...
    /* C8FB8 801FA988 3C05801A */  lui        $a1, %hi(D_801982F0)
    ...
    /* C8FCC 801FA99C 8CA582F0 */  lw         $a1, %lo(D_801982F0)($a1)
    /* C8FD0 801FA9A0 3C06800E */  lui        $a2, %hi(D_800DAB28)
    /* C8FD4 801FA9A4 8CC6AB28 */  lw         $a2, %lo(D_800DAB28)($a2)
  ...
  .LA95D0_801FA9E0:
    ...
    /* C9078 801FAA48 3C06800E */  lui        $a2, %hi(D_800DAB28)
    /* C907C 801FAA4C 8CC6AB28 */  lw         $a2, %lo(D_800DAB28)($a2)
    /* C9080 801FAA50 26100008 */  addiu      $s0, $s0, 0x8
    /* C9084 801FAA54 3C05801A */  lui        $a1, %hi(D_801982F0)
    ...
    /* C90B0 801FAA80 8CA582F0 */  lw         $a1, %lo(D_801982F0)($a1)
  ...
  .LA95D0_801FABB0:
    ...
    /* C9314 801FACE4 3C06800E */  lui        $a2, %hi(D_800DAB28)
    /* C9318 801FACE8 3C05801A */  lui        $a1, %hi(D_801982F0)
    /* C931C 801FACEC 8CA582F0 */  lw         $a1, %lo(D_801982F0)($a1)
    /* C9320 801FACF0 8CC6AB28 */  lw         $a2, %lo(D_800DAB28)($a2)
...
.size func_A95D0_801FA3C0, . - func_A95D0_801FA3C0
