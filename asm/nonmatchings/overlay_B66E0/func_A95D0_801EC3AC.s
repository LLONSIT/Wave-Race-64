glabel func_A95D0_801EC3AC
    ...
    /* BAA3C 801EC40C 3C01800E */  lui        $at, %hi(D_800DAB28)
    /* BAA40 801EC410 AC26AB28 */  sw         $a2, %lo(D_800DAB28)($at)
    /* BAA44 801EC414 3C01801A */  lui        $at, %hi(D_801982F0)
    /* BAA48 801EC418 3C0D800D */  lui        $t5, %hi(D_800D48DC)
    /* BAA4C 801EC41C 8DAD48DC */  lw         $t5, %lo(D_800D48DC)($t5)
    /* BAA50 801EC420 AC2682F0 */  sw         $a2, %lo(D_801982F0)($at)
    /* BAA54 801EC424 3C01800E */  lui        $at, %hi(D_800D8170)
    /* BAA58 801EC428 24190009 */  addiu      $t9, $zero, 0x9
    /* BAA5C 801EC42C AC398170 */  sw         $t9, %lo(D_800D8170)($at)
    /* BAA60 801EC430 24070002 */  addiu      $a3, $zero, 0x2
    /* BAA64 801EC434 3C01801D */  lui        $at, %hi(D_801CE648)
    /* BAA68 801EC438 000D7080 */  sll        $t6, $t5, 2
    /* BAA6C 801EC43C AC27E648 */  sw         $a3, %lo(D_801CE648)($at)
...
.size func_A95D0_801EC3AC, . - func_A95D0_801EC3AC
