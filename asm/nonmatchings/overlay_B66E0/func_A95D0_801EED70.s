glabel func_A95D0_801EED70
  ...
  .LA95D0_801EEE64:
    ...
    /* BD550 801EEF20 3C07800E */  lui        $a3, %hi(D_800D8170)
    /* BD554 801EEF24 8CE78170 */  lw         $a3, %lo(D_800D8170)($a3)
    ...
    /* BD570 801EEF40 3C11801D */  lui        $s1, %hi(D_801CE620)
    /* BD574 801EEF44 8E31E620 */  lw         $s1, %lo(D_801CE620)($s1)
  ...
  .LA95D0_801EEF58:
    /* BD588 801EEF58 3C11801D */  lui        $s1, %hi(D_801CE620)
    /* BD58C 801EEF5C 8E31E620 */  lw         $s1, %lo(D_801CE620)($s1)
    /* BD590 801EEF60 10000001 */  b          .LA95D0_801EEF68
    /* BD594 801EEF64 24030001 */   addiu     $v1, $zero, 0x1
  .LA95D0_801EEF68:
    /* BD598 801EEF68 3C0B801A */  lui        $t3, %hi(D_801982F0)
    /* BD59C 801EEF6C 8D6B82F0 */  lw         $t3, %lo(D_801982F0)($t3)
    /* BD5A0 801EEF70 3C058023 */  lui        $a1, %hi(D_A95D0_80228C28)
    /* BD5A4 801EEF74 3C10800E */  lui        $s0, %hi(D_800DAB28)
  ...
  .LA95D0_801EEF9C:
    /* BD5CC 801EEF9C 8E10AB28 */  lw         $s0, %lo(D_800DAB28)($s0)
...
.size func_A95D0_801EED70, . - func_A95D0_801EED70
