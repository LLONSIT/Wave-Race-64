glabel func_A95D0_801EB4F4
    ...
    /* B9B94 801EB564 3C01801D */  lui        $at, %hi(D_801CB338)
    /* B9B98 801EB568 AFBF0024 */  sw         $ra, 0x24($sp)
    /* B9B9C 801EB56C 10400005 */  beqz       $v0, .LA95D0_801EB584
    /* B9BA0 801EB570 AC2AB338 */   sw        $t2, %lo(D_801CB338)($at)
  ...
  .LA95D0_801EB584:
    ...
    /* B9BB8 801EB588 3C01801D */  lui        $at, %hi(D_801CE620)
    /* B9BBC 801EB58C AC29E620 */  sw         $t1, %lo(D_801CE620)($at)
    /* B9BC0 801EB590 3C01800E */  lui        $at, %hi(D_800DAB28)
    /* B9BC4 801EB594 AC30AB28 */  sw         $s0, %lo(D_800DAB28)($at)
    /* B9BC8 801EB598 3C08801D */  lui        $t0, %hi(D_801CB330)
    /* B9BCC 801EB59C 3C01801A */  lui        $at, %hi(D_801982F0)
    /* B9BD0 801EB5A0 2508B330 */  addiu      $t0, $t0, %lo(D_801CB330)
    /* B9BD4 801EB5A4 AC2982F0 */  sw         $t1, %lo(D_801982F0)($at)
    ...
    /* B9BE8 801EB5B8 3C01800E */  lui        $at, %hi(D_800D8170)
    /* B9BEC 801EB5BC 25ADAC44 */  addiu      $t5, $t5, %lo(D_800EAC44)
    /* B9BF0 801EB5C0 000B60C0 */  sll        $t4, $t3, 3
    /* B9BF4 801EB5C4 AC2A8170 */  sw         $t2, %lo(D_800D8170)($at)
    ...
    /* B9C44 801EB614 3C05800E */  lui        $a1, %hi(D_800D8170)
    /* B9C48 801EB618 AC2FE704 */  sw         $t7, %lo(D_801CE704)($at)
    /* B9C4C 801EB61C 8CA58170 */  lw         $a1, %lo(D_800D8170)($a1)
  ...
  .LA95D0_801EB630:
    ...
    /* B9C64 801EB634 3C01801D */  lui        $at, %hi(D_801CE620)
    /* B9C68 801EB638 AC38E620 */  sw         $t8, %lo(D_801CE620)($at)
    /* B9C6C 801EB63C 3C01800E */  lui        $at, %hi(D_800DAB28)
    /* B9C70 801EB640 AC30AB28 */  sw         $s0, %lo(D_800DAB28)($at)
    /* B9C74 801EB644 3C01801A */  lui        $at, %hi(D_801982F0)
    /* B9C78 801EB648 2508B330 */  addiu      $t0, $t0, %lo(D_801CB330)
    /* B9C7C 801EB64C AC3082F0 */  sw         $s0, %lo(D_801982F0)($at)
    ...
    /* B9CD4 801EB6A4 3C05800E */  lui        $a1, %hi(D_800D8170)
    /* B9CD8 801EB6A8 AC20E6F8 */  sw         $zero, %lo(D_801CE6F8)($at)
    /* B9CDC 801EB6AC 8CA58170 */  lw         $a1, %lo(D_800D8170)($a1)
  ...
  .LA95D0_801EB6C0:
    /* B9CF0 801EB6C0 3C01801D */  lui        $at, %hi(D_801CE620)
    /* B9CF4 801EB6C4 AC30E620 */  sw         $s0, %lo(D_801CE620)($at)
    /* B9CF8 801EB6C8 3C01800E */  lui        $at, %hi(D_800DAB28)
    /* B9CFC 801EB6CC AC2AAB28 */  sw         $t2, %lo(D_800DAB28)($at)
    /* B9D00 801EB6D0 3C01801A */  lui        $at, %hi(D_801982F0)
    /* B9D04 801EB6D4 2508B330 */  addiu      $t0, $t0, %lo(D_801CB330)
    /* B9D08 801EB6D8 AC2A82F0 */  sw         $t2, %lo(D_801982F0)($at)
    ...
    /* B9D1C 801EB6EC 3C01800E */  lui        $at, %hi(D_800D8170)
    /* B9D20 801EB6F0 2718AC44 */  addiu      $t8, $t8, %lo(D_800EAC44)
    /* B9D24 801EB6F4 000E78C0 */  sll        $t7, $t6, 3
    /* B9D28 801EB6F8 AC308170 */  sw         $s0, %lo(D_800D8170)($at)
    ...
    /* B9D70 801EB740 3C05800E */  lui        $a1, %hi(D_800D8170)
    /* B9D74 801EB744 AC20E6F8 */  sw         $zero, %lo(D_801CE6F8)($at)
    /* B9D78 801EB748 8CA58170 */  lw         $a1, %lo(D_800D8170)($a1)
  ...
  .LA95D0_801EB754:
    ...
    /* B9DA4 801EB774 3C0D801D */  lui        $t5, %hi(D_801CE620)
    /* B9DA8 801EB778 8DADE620 */  lw         $t5, %lo(D_801CE620)($t5)
    /* B9DAC 801EB77C 3C02801D */  lui        $v0, %hi(D_801CE608)
    /* B9DB0 801EB780 2442E608 */  addiu      $v0, $v0, %lo(D_801CE608)
    /* B9DB4 801EB784 3C0E800E */  lui        $t6, %hi(D_800DAB28)
    /* B9DB8 801EB788 AC4D0000 */  sw         $t5, 0x0($v0)
    /* B9DBC 801EB78C 8DCEAB28 */  lw         $t6, %lo(D_800DAB28)($t6)
    /* B9DC0 801EB790 3C04801A */  lui        $a0, %hi(D_801982F0)
    /* B9DC4 801EB794 3C19801D */  lui        $t9, %hi(D_801CE728)
    /* B9DC8 801EB798 A44E0004 */  sh         $t6, 0x4($v0)
    /* B9DCC 801EB79C 8C8482F0 */  lw         $a0, %lo(D_801982F0)($a0)
    ...
    /* B9E14 801EB7E4 3C0C800E */  lui        $t4, %hi(D_800D8170)
    /* B9E18 801EB7E8 8D8C8170 */  lw         $t4, %lo(D_800D8170)($t4)
  ...
  .LA95D0_801EB858:
    ...
    /* B9E9C 801EB86C 3C01801D */  lui        $at, %hi(D_801CE648)
    /* B9EA0 801EB870 A46E0000 */  sh         $t6, 0x0($v1)
    /* B9EA4 801EB874 AC2FE648 */  sw         $t7, %lo(D_801CE648)($at)
    /* B9EA8 801EB878 3C02800E */  lui        $v0, %hi(D_800D8170)
    /* B9EAC 801EB87C 8C428170 */  lw         $v0, %lo(D_800D8170)($v0)
  ...
  .LA95D0_801EB8A8:
    ...
    /* B9F20 801EB8F0 3C0C800E */  lui        $t4, %hi(D_800DAB28)
    /* B9F24 801EB8F4 8D8CAB28 */  lw         $t4, %lo(D_800DAB28)($t4)
...
.size func_A95D0_801EB4F4, . - func_A95D0_801EB4F4
