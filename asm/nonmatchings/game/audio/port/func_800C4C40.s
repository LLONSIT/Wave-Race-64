glabel func_800C4C40
    ...
    /* 7F44C 800C4C4C 3C188004 */  lui        $t8, %hi(gAudioBufferParameters)
    ...
    /* 7F460 800C4C60 87185520 */  lh         $t8, %lo(gAudioBufferParameters)($t8)
  ...
  .L800C4D90:
    /* 7F590 800C4D90 3C038004 */  lui        $v1, %hi(gCurrAudioFrameDmaCount)
    /* 7F594 800C4D94 24635554 */  addiu      $v1, $v1, %lo(gCurrAudioFrameDmaCount)
    /* 7F598 800C4D98 0C02E38D */  jal        decrease_sample_dma_ttls
  ...
  .L800C4E28:
    ...
    /* 7F66C 800C4E6C 3C058004 */  lui        $a1, %hi(gAudioBufferParameters)
    /* 7F670 800C4E70 3C018004 */  lui        $at, %hi(D_80045568)
    /* 7F674 800C4E74 24A55520 */  addiu      $a1, $a1, %lo(gAudioBufferParameters)
