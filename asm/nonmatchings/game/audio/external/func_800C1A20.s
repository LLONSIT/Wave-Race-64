glabel func_800C1A20
    ...
    /* 7C24C 800C1A4C 0C0314F5 */  jal        play_sound
    ...
    /* 7C25C 800C1A5C 0C0314F5 */  jal        play_sound
    ...
    /* 7C26C 800C1A6C 0C0314F5 */  jal        play_sound
    ...
    /* 7C27C 800C1A7C 0C0314F5 */  jal        play_sound
  ...
  .L800C1A90:
    ...
    /* 7C298 800C1A98 0C0314F5 */  jal        play_sound
    ...
    /* 7C2A8 800C1AA8 0C0314F5 */  jal        play_sound
  ...
  .L800C1AC0:
    ...
    /* 7C2C8 800C1AC8 0C0314F5 */  jal        play_sound
    ...
    /* 7C2D8 800C1AD8 0C0314F5 */  jal        play_sound
