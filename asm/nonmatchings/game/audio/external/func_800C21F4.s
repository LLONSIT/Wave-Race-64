glabel func_800C21F4
  ...
  .L800C2310:
    /* 7CB10 800C2310 0C0314F5 */  jal        play_sound
    ...
    /* 7CB24 800C2324 0C0314F5 */  jal        play_sound
    ...
    /* 7CB34 800C2334 0C0314F5 */  jal        play_sound
    ...
    /* 7CB44 800C2344 0C0314F5 */  jal        play_sound
    ...
    /* 7CB54 800C2354 0C0314F5 */  jal        play_sound
    ...
    /* 7CB64 800C2364 0C0314F5 */  jal        play_sound
    ...
    /* 7CB74 800C2374 0C0314F5 */  jal        play_sound
  ...
  .L800C24D4:
    ...
    /* 7CD08 800C2508 0C0314F5 */  jal        play_sound
    ...
    /* 7CD18 800C2518 0C0314F5 */  jal        play_sound
    ...
    /* 7CD28 800C2528 0C0314F5 */  jal        play_sound
    ...
    /* 7CD38 800C2538 0C0314F5 */  jal        play_sound
    ...
    /* 7CD48 800C2548 0C0314F5 */  jal        play_sound
    ...
    /* 7CD58 800C2558 0C0314F5 */  jal        play_sound
  ...
  .L800C2798:
    ...
    /* 7CFC0 800C27C0 0C0314F5 */  jal        play_sound
    ...
    /* 7CFD0 800C27D0 0C0314F5 */  jal        play_sound
    ...
    /* 7CFE0 800C27E0 0C0314F5 */  jal        play_sound
    ...
    /* 7CFF0 800C27F0 0C0314F5 */  jal        play_sound
    ...
    /* 7D000 800C2800 0C0314F5 */  jal        play_sound
    ...
    /* 7D010 800C2810 0C0314F5 */  jal        play_sound
  ...
  .L800C28C0:
    ...
    /* 7D0EC 800C28EC 0C0314F5 */  jal        play_sound
    ...
    /* 7D0FC 800C28FC 0C0314F5 */  jal        play_sound
    ...
    /* 7D10C 800C290C 0C0314F5 */  jal        play_sound
    ...
    /* 7D11C 800C291C 0C0314F5 */  jal        play_sound
    ...
    /* 7D12C 800C292C 0C0314F5 */  jal        play_sound
    ...
    /* 7D13C 800C293C 0C0314F5 */  jal        play_sound
  ...
  .L800C2D74:
    ...
    /* 7D594 800C2D94 0C0314F5 */  jal        play_sound
    ...
    /* 7D5BC 800C2DBC 3C02801D */  lui        $v0, %hi(gDifficulty)
    /* 7D5C0 800C2DC0 8C42B338 */  lw         $v0, %lo(gDifficulty)($v0)
  ...
  .L800C2EC0:
    /* 7D6C0 800C2EC0 0C0314F5 */  jal        play_sound
  ...
  .L800C2ED0:
    ...
    /* 7D6D4 800C2ED4 0C0314F5 */  jal        play_sound
