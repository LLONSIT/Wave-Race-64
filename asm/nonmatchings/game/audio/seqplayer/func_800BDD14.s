glabel func_800BDD14
  ...
  .L800BDFB0:
    ...
    /* 7886C 800BE06C 3C048004 */  lui        $a0, %hi(gBankLoadedPool)
    /* 78870 800BE070 0078C821 */  addu       $t9, $v1, $t8
    /* 78874 800BE074 97270000 */  lhu        $a3, 0x0($t9)
    /* 78878 800BE078 2484E7A0 */  addiu      $a0, $a0, %lo(gBankLoadedPool)
  ...
  .L800BE0AC:
    ...
    /* 78AFC 800BE2FC 3C048004 */  lui        $a0, %hi(gBankLoadedPool)
    /* 78B00 800BE300 00796821 */  addu       $t5, $v1, $t9
    /* 78B04 800BE304 95A70000 */  lhu        $a3, 0x0($t5)
    /* 78B08 800BE308 2484E7A0 */  addiu      $a0, $a0, %lo(gBankLoadedPool)
