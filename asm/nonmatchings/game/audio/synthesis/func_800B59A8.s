glabel func_800B59A8
    ...
    /* 701F8 800B59F8 3C048004 */  lui        $a0, %hi(gMaxSimultaneousNotes)
    /* 701FC 800B59FC 8C845548 */  lw         $a0, %lo(gMaxSimultaneousNotes)($a0)
  ...
  .L800B5A68:
    ...
    /* 70270 800B5A70 3C048004 */  lui        $a0, %hi(gMaxSimultaneousNotes)
    /* 70274 800B5A74 8C845548 */  lw         $a0, %lo(gMaxSimultaneousNotes)($a0)
  ...
  .L800B5B04:
    /* 70304 800B5B04 3C048004 */  lui        $a0, %hi(gMaxSimultaneousNotes)
    /* 70308 800B5B08 8C845548 */  lw         $a0, %lo(gMaxSimultaneousNotes)($a0)
  ...
  .L800B5C2C:
    /* 7042C 800B5C2C 3C198004 */  lui        $t9, %hi(gMaxSimultaneousNotes)
    /* 70430 800B5C30 8F395548 */  lw         $t9, %lo(gMaxSimultaneousNotes)($t9)
  ...
  .L800B5D24:
    /* 70524 800B5D24 3C188004 */  lui        $t8, %hi(gMaxSimultaneousNotes)
    /* 70528 800B5D28 8F185548 */  lw         $t8, %lo(gMaxSimultaneousNotes)($t8)
    ...
    /* 70540 800B5D40 3C0F8004 */  lui        $t7, %hi(gBankLoadStatus)
    ...
    /* 7055C 800B5D5C 91EFEB78 */  lbu        $t7, %lo(gBankLoadStatus)($t7)
