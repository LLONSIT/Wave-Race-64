glabel func_800BAB94
    ...
    /* 75398 800BAB98 3C038004 */  lui        $v1, %hi(gMaxSimultaneousNotes)
    /* 7539C 800BAB9C 8C635548 */  lw         $v1, %lo(gMaxSimultaneousNotes)($v1)
  ...
  .L800BAC48:
    ...
    /* 75460 800BAC60 3C038004 */  lui        $v1, %hi(gMaxSimultaneousNotes)
    /* 75464 800BAC64 8C635548 */  lw         $v1, %lo(gMaxSimultaneousNotes)($v1)
  ...
  .L800BAED4:
    /* 756D4 800BAED4 3C038004 */  lui        $v1, %hi(gMaxSimultaneousNotes)
    /* 756D8 800BAED8 8C635548 */  lw         $v1, %lo(gMaxSimultaneousNotes)($v1)
