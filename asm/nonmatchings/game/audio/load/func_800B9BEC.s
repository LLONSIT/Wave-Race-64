glabel func_800B9BEC
    ...
    /* 74458 800B9C58 3C178004 */  lui        $s7, %hi(gBankLoadedPool)
    /* 7445C 800B9C5C 3C168004 */  lui        $s6, %hi(gBankLoadStatus)
    /* 74460 800B9C60 26D6EB78 */  addiu      $s6, $s6, %lo(gBankLoadStatus)
    /* 74464 800B9C64 26F7E7A0 */  addiu      $s7, $s7, %lo(gBankLoadedPool)
