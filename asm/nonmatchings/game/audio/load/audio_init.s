glabel audio_init
  ...
  .L800BA1A0:
    /* 749A0 800BA1A0 3C028000 */  lui        $v0, %hi(osTvType)
    /* 749A4 800BA1A4 8C420300 */  lw         $v0, %lo(osTvType)($v0)
  ...
  .L800BA240:
    ...
    /* 74A84 800BA284 3C048004 */  lui        $a0, %hi(gAudioDmaMesgQueue)
    ...
    /* 74A98 800BA298 24844DB8 */  addiu      $a0, $a0, %lo(gAudioDmaMesgQueue)
    /* 74A9C 800BA29C 0C0318C4 */  jal        osCreateMesgQueue
    /* 74AA0 800BA2A0 24060001 */   addiu     $a2, $zero, 0x1
    /* 74AA4 800BA2A4 3C048004 */  lui        $a0, %hi(gCurrAudioFrameDmaQueue)
    /* 74AA8 800BA2A8 3C058004 */  lui        $a1, %hi(D_800447B8)
    /* 74AAC 800BA2AC 24A547B8 */  addiu      $a1, $a1, %lo(D_800447B8)
    /* 74AB0 800BA2B0 248447A0 */  addiu      $a0, $a0, %lo(gCurrAudioFrameDmaQueue)
    /* 74AB4 800BA2B4 0C0318C4 */  jal        osCreateMesgQueue
    /* 74AB8 800BA2B8 24060040 */   addiu     $a2, $zero, 0x40
    /* 74ABC 800BA2BC 3C018004 */  lui        $at, %hi(gCurrAudioFrameDmaCount)
    /* 74AC0 800BA2C0 AC205554 */  sw         $zero, %lo(gCurrAudioFrameDmaCount)($at)
    /* 74AC4 800BA2C4 3C018004 */  lui        $at, %hi(gSampleDmaNumListItems)
    /* 74AC8 800BA2C8 3C04800F */  lui        $a0, %hi(D_800EE2FC)
    /* 74ACC 800BA2CC AC2052F0 */  sw         $zero, %lo(gSampleDmaNumListItems)($at)
  ...
  .L800BA2F0:
    ...
    /* 74AF4 800BA2F4 0C02DDD8 */  jal        soundAlloc
  ...
  .L800BA30C:
    ...
    /* 74B88 800BA388 0C02E32C */  jal        audio_dma_copy_immediate
    ...
    /* 74BC4 800BA3C4 0C02DDD8 */  jal        soundAlloc
    ...
    /* 74BE4 800BA3E4 0C02E32C */  jal        audio_dma_copy_immediate
    ...
    /* 74C00 800BA400 3C028004 */  lui        $v0, %hi(gAlCtlHeader)
    /* 74C04 800BA404 24425508 */  addiu      $v0, $v0, %lo(gAlCtlHeader)
    ...
    /* 74C18 800BA418 0C02E32C */  jal        audio_dma_copy_immediate
    /* 74C1C 800BA41C 24060010 */   addiu     $a2, $zero, 0x10
    /* 74C20 800BA420 3C0F8004 */  lui        $t7, %hi(gAlCtlHeader)
    /* 74C24 800BA424 8DEF5508 */  lw         $t7, %lo(gAlCtlHeader)($t7)
    ...
    /* 74C4C 800BA44C 0C02DDD8 */  jal        soundAlloc
    /* 74C50 800BA450 00052880 */   sll       $a1, $a1, 2
    /* 74C54 800BA454 3C018004 */  lui        $at, %hi(gCtlEntries)
    /* 74C58 800BA458 AC225518 */  sw         $v0, %lo(gCtlEntries)($at)
    /* 74C5C 800BA45C 02202025 */  or         $a0, $s1, $zero
    /* 74C60 800BA460 0C02DDD8 */  jal        soundAlloc
    /* 74C64 800BA464 02002825 */   or        $a1, $s0, $zero
    /* 74C68 800BA468 3C038004 */  lui        $v1, %hi(gAlCtlHeader)
    /* 74C6C 800BA46C 24635508 */  addiu      $v1, $v1, %lo(gAlCtlHeader)
    ...
    /* 74C80 800BA480 0C02E32C */  jal        audio_dma_copy_immediate
    /* 74C84 800BA484 02003025 */   or        $a2, $s0, $zero
    /* 74C88 800BA488 3C048004 */  lui        $a0, %hi(gAlCtlHeader)
    ...
    /* 74C98 800BA498 8C845508 */   lw        $a0, %lo(gAlCtlHeader)($a0)
    /* 74C9C 800BA49C 3C028004 */  lui        $v0, %hi(gAlTbl)
    /* 74CA0 800BA4A0 2442550C */  addiu      $v0, $v0, %lo(gAlTbl)
    ...
    /* 74CB4 800BA4B4 0C02E32C */  jal        audio_dma_copy_immediate
    /* 74CB8 800BA4B8 24060010 */   addiu     $a2, $zero, 0x10
    /* 74CBC 800BA4BC 3C088004 */  lui        $t0, %hi(gAlTbl)
    /* 74CC0 800BA4C0 8D08550C */  lw         $t0, %lo(gAlTbl)($t0)
    ...
    /* 74CE0 800BA4E0 0C02DDD8 */  jal        soundAlloc
    /* 74CE4 800BA4E4 00A08025 */   or        $s0, $a1, $zero
    /* 74CE8 800BA4E8 3C038004 */  lui        $v1, %hi(gAlTbl)
    /* 74CEC 800BA4EC 2463550C */  addiu      $v1, $v1, %lo(gAlTbl)
    ...
    /* 74D00 800BA500 0C02E32C */  jal        audio_dma_copy_immediate
    /* 74D04 800BA504 02003025 */   or        $a2, $s0, $zero
    /* 74D08 800BA508 3C048004 */  lui        $a0, %hi(gAlTbl)
    ...
    /* 74D18 800BA518 8C84550C */   lw        $a0, %lo(gAlTbl)($a0)
    /* 74D1C 800BA51C 02202025 */  or         $a0, $s1, $zero
    /* 74D20 800BA520 0C02DDD8 */  jal        soundAlloc
    ...
    /* 74D40 800BA540 0C02E32C */  jal        audio_dma_copy_immediate
