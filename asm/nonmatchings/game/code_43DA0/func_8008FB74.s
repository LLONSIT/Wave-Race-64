glabel func_8008FB74
    ...
    /* 4A3FC 8008FBFC 3C19800E */  lui        $t9, %hi(gPlayers)
    /* 4A400 8008FC00 8F39AB28 */  lw         $t9, %lo(gPlayers)($t9)
    ...
    /* 4A410 8008FC10 3C18800E */   lui       $t8, %hi(gCourseID)
    /* 4A414 8008FC14 8F188170 */  lw         $t8, %lo(gCourseID)($t8)
  ...
  .L8008FC38:
    ...
    /* 4A4A4 8008FCA4 3C19800E */   lui       $t9, %hi(gPlayers)
  .L8008FCA8:
  ...
  .L8008FEA4:
    /* 4A6A4 8008FEA4 8F39AB28 */  lw         $t9, %lo(gPlayers)($t9)
  ...
  .L80090170:
    /* 4A970 80090170 3C0E800E */  lui        $t6, %hi(gCourseID)
    /* 4A974 80090174 8DCE8170 */  lw         $t6, %lo(gCourseID)($t6)
    /* 4A978 80090178 3C0F800E */  lui        $t7, %hi(gPlayers)
    ...
    /* 4A988 80090188 8DEFAB28 */  lw         $t7, %lo(gPlayers)($t7)
  ...
  .L800901F4:
    ...
    /* 4AA08 80090208 3C18800E */  lui        $t8, %hi(gCourseID)
    /* 4AA0C 8009020C 8F188170 */  lw         $t8, %lo(gCourseID)($t8)
  ...
  .L80090420:
    /* 4AC20 80090420 3C0F800E */  lui        $t7, %hi(gPlayers)
    /* 4AC24 80090424 8DEFAB28 */  lw         $t7, %lo(gPlayers)($t7)
  ...
  .L80090444:
    /* 4AC44 80090444 3C18800E */   lui       $t8, %hi(gCourseID)
    /* 4AC48 80090448 8F188170 */  lw         $t8, %lo(gCourseID)($t8)
  ...
  .L80090454:
    ...
    /* 4AD2C 8009052C 3C19800E */  lui        $t9, %hi(gCourseID)
    /* 4AD30 80090530 8F398170 */  lw         $t9, %lo(gCourseID)($t9)
  ...
  .L80090558:
    ...
    /* 4AE3C 8009063C 3C0E800E */  lui        $t6, %hi(gPlayers)
    /* 4AE40 80090640 8DCEAB28 */  lw         $t6, %lo(gPlayers)($t6)
  ...
  .L80090C18:
    ...
    /* 4B42C 80090C2C 3C03800E */   lui       $v1, %hi(gPlayers)
  ...
  .L80090C6C:
    ...
    /* 4B480 80090C80 8C63AB28 */  lw         $v1, %lo(gPlayers)($v1)
    /* 4B484 80090C84 24C60008 */  addiu      $a2, $a2, 0x8
    /* 4B488 80090C88 3C02800E */  lui        $v0, %hi(gCourseID)
    /* 4B48C 80090C8C 1563002D */  bne        $t3, $v1, .L80090D44
    /* 4B490 80090C90 00000000 */   nop
    /* 4B494 80090C94 8C428170 */  lw         $v0, %lo(gCourseID)($v0)
  ...
  .L80090CC4:
    ...
    /* 4B4CC 80090CCC 3C03800E */  lui        $v1, %hi(gPlayers)
    ...
    /* 4B4E4 80090CE4 8C63AB28 */   lw        $v1, %lo(gPlayers)($v1)
  .L80090CE8:
    ...
    /* 4B4F8 80090CF8 3C03800E */  lui        $v1, %hi(gPlayers)
    ...
    /* 4B510 80090D10 8C63AB28 */   lw        $v1, %lo(gPlayers)($v1)
  .L80090D14:
    ...
    /* 4B52C 80090D2C 3C03800E */  lui        $v1, %hi(gPlayers)
    /* 4B530 80090D30 8C63AB28 */  lw         $v1, %lo(gPlayers)($v1)
