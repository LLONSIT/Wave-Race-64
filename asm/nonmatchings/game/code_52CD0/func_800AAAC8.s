glabel func_800AAAC8
    ...
    /* 65328 800AAB28 3C19800E */  lui        $t9, %hi(gCourseID)
    /* 6532C 800AAB2C 01520019 */  multu      $t2, $s2
    /* 65330 800AAB30 8F398170 */  lw         $t9, %lo(gCourseID)($t9)
  ...
  .L800AABE8:
    ...
    /* 653F8 800AABF8 3C0D800E */  lui        $t5, %hi(gCourseID)
    /* 653FC 800AABFC 8DAD8170 */  lw         $t5, %lo(gCourseID)($t5)
    ...
    /* 6545C 800AAC5C 0C011F94 */  jal        rand
    ...
    /* 65494 800AAC94 0C011F94 */  jal        rand
  ...
  .L800AAD48:
    ...
    /* 65598 800AAD98 3C038015 */  lui        $v1, %hi(gSinTable)
    /* 6559C 800AAD9C 24634350 */  addiu      $v1, $v1, %lo(gSinTable)
  ...
  .L800AADE8:
    ...
    /* 65604 800AAE04 3C0A800E */  lui        $t2, %hi(gCourseID)
    ...
    /* 65664 800AAE64 8D4A8170 */  lw         $t2, %lo(gCourseID)($t2)
  ...
  .L800AAE90:
    ...
    /* 656A8 800AAEA8 3C18800E */  lui        $t8, %hi(gCourseID)
    /* 656AC 800AAEAC 8F188170 */  lw         $t8, %lo(gCourseID)($t8)
  ...
  .L800AB0D4:
    ...
    /* 65910 800AB110 3C038015 */  lui        $v1, %hi(gSinTable)
    /* 65914 800AB114 24634350 */  addiu      $v1, $v1, %lo(gSinTable)
  ...
  .L800AB214:
    ...
    /* 65A18 800AB218 3C0B800E */  lui        $t3, %hi(gCourseID)
    /* 65A1C 800AB21C 8D6B8170 */  lw         $t3, %lo(gCourseID)($t3)
