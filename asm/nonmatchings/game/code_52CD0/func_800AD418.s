glabel func_800AD418
    ...
    /* 67C48 800AD448 3C18800E */  lui        $t8, %hi(gPlayers)
  ...
  .L800AD460:
    ...
    /* 67C6C 800AD46C 8F18AB28 */  lw         $t8, %lo(gPlayers)($t8)
  ...
  .L800AD670:
    ...
    /* 67E88 800AD688 3C0D800E */  lui        $t5, %hi(gPlayers)
    /* 67E8C 800AD68C 8DADAB28 */  lw         $t5, %lo(gPlayers)($t5)
  ...
  .L800AD760:
    ...
    /* 68054 800AD854 3C0D800E */  lui        $t5, %hi(gPlayers)
  ...
  .L800AD880:
    /* 68080 800AD880 8DADAB28 */  lw         $t5, %lo(gPlayers)($t5)
  ...
  .L800AD918:
    /* 68118 800AD918 3C19800E */  lui        $t9, %hi(gCourseID)
    /* 6811C 800AD91C 8F398170 */  lw         $t9, %lo(gCourseID)($t9)
