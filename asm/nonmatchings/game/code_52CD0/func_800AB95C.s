glabel func_800AB95C
    ...
    /* 66170 800AB970 3C0E8022 */  lui        $t6, %hi(D_80223930)
    /* 66174 800AB974 8DCE3930 */  lw         $t6, %lo(D_80223930)($t6)
    /* 66178 800AB978 3C0D800E */  lui        $t5, %hi(gPlayers)
    /* 6617C 800AB97C 8DADAB28 */  lw         $t5, %lo(gPlayers)($t5)
    ...
    /* 66190 800AB990 3C188022 */  lui        $t8, %hi(gCameraPerspective)
    ...
    /* 661A4 800AB9A4 27187C80 */  addiu      $t8, $t8, %lo(gCameraPerspective)
  ...
  .L800ABB84:
    ...
    /* 6639C 800ABB9C 3C0F800E */  lui        $t7, %hi(gPlayers)
    /* 663A0 800ABBA0 8DEFAB28 */  lw         $t7, %lo(gPlayers)($t7)
  ...
  .L800ABC60:
    ...
    /* 66548 800ABD48 3C0C800E */  lui        $t4, %hi(gPlayers)
  ...
  .L800ABD64:
    /* 66564 800ABD64 8D8CAB28 */  lw         $t4, %lo(gPlayers)($t4)
  ...
  .L800ABEB4:
    ...
    /* 666D4 800ABED4 3C158015 */  lui        $s5, %hi(gSinTable)
    ...
    /* 666E8 800ABEE8 26B54350 */  addiu      $s5, $s5, %lo(gSinTable)
  ...
  .L800ABF54:
    /* 66754 800ABF54 0C011F94 */  jal        rand
    ...
    /* 66790 800ABF90 0C011F94 */  jal        rand
    ...
    /* 667D0 800ABFD0 0C011F94 */  jal        rand
