glabel func_8006AC84
    ...
    /* 254A0 8006ACA0 3C0E800E */  lui        $t6, %hi(gCourseID)
    /* 254A4 8006ACA4 8DCE8170 */  lw         $t6, %lo(gCourseID)($t6)
    ...
    /* 254B4 8006ACB4 3C18801B */   lui       $t8, %hi(D_801AEE20)
    /* 254B8 8006ACB8 3C03801A */  lui        $v1, %hi(gRiders)
    /* 254BC 8006ACBC 8C6382F0 */  lw         $v1, %lo(gRiders)($v1)
  ...
  .L8006AE30:
    ...
    /* 25644 8006AE44 2718EE20 */   addiu     $t8, $t8, %lo(D_801AEE20)
  ...
  .L8006AED0:
    ...
    /* 256D8 8006AED8 3C03801A */   lui       $v1, %hi(gRiders)
  ...
  .L8006AFA4:
    /* 257A4 8006AFA4 8C6382F0 */  lw         $v1, %lo(gRiders)($v1)
    /* 257A8 8006AFA8 24060001 */  addiu      $a2, $zero, 0x1
    /* 257AC 8006AFAC 3C0B801D */  lui        $t3, %hi(gGameModes)
    ...
    /* 257C0 8006AFC0 8D6BE620 */  lw         $t3, %lo(gGameModes)($t3)
    ...
    /* 257D8 8006AFD8 3C0C800E */  lui        $t4, %hi(gCourseID)
    /* 257DC 8006AFDC 8D8C8170 */  lw         $t4, %lo(gCourseID)($t4)
  ...
  .L8006AFFC:
    /* 257FC 8006AFFC 3C02800E */  lui        $v0, %hi(gCourseID)
    /* 25800 8006B000 10000099 */  b          .L8006B268
    /* 25804 8006B004 8C428170 */   lw        $v0, %lo(gCourseID)($v0)
  .L8006B008:
    ...
    /* 25820 8006B020 3C02800E */   lui       $v0, %hi(gCourseID)
  ...
  .L8006B04C:
    /* 2584C 8006B04C 8C428170 */  lw         $v0, %lo(gCourseID)($v0)
  ...
  .L8006B08C:
    ...
    /* 25890 8006B090 3C18801D */   lui       $t8, %hi(gGameModes)
    ...
    /* 258CC 8006B0CC 3C02800E */  lui        $v0, %hi(gCourseID)
    /* 258D0 8006B0D0 44808000 */  mtc1       $zero, $f16
    /* 258D4 8006B0D4 8C428170 */  lw         $v0, %lo(gCourseID)($v0)
  ...
  .L8006B104:
    /* 25904 8006B104 8F18E620 */  lw         $t8, %lo(gGameModes)($t8)
  ...
  .L8006B1C8:
    ...
    /* 259E8 8006B1E8 3C02800E */  lui        $v0, %hi(gCourseID)
    /* 259EC 8006B1EC 44808000 */  mtc1       $zero, $f16
    /* 259F0 8006B1F0 8C428170 */  lw         $v0, %lo(gCourseID)($v0)
  ...
  .L8006B204:
    ...
    /* 25A34 8006B234 3C02800E */  lui        $v0, %hi(gCourseID)
    /* 25A38 8006B238 44808000 */  mtc1       $zero, $f16
    /* 25A3C 8006B23C 8C428170 */  lw         $v0, %lo(gCourseID)($v0)
