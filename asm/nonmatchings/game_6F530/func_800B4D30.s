...
glabel func_800B4D30
    ...
    /* 6F53C 800B4D3C 00E43820 */  add        $a3, $a3, $a0 /* handwritten instruction */
    /* 6F540 800B4D40 0324C820 */  add        $t9, $t9, $a0 /* handwritten instruction */
    /* 6F544 800B4D44 00003025 */  or         $a2, $zero, $zero
    /* 6F548 800B4D48 20840010 */  addi       $a0, $a0, 0x10 /* handwritten instruction */
    /* 6F54C 800B4D4C 0305C020 */  add        $t8, $t8, $a1 /* handwritten instruction */
  .L800B4D50:
    ...
    /* 6F560 800B4D60 20840004 */  addi       $a0, $a0, 0x4 /* handwritten instruction */
  ...
  .L800B4D68:
    ...
    /* 6F574 800B4D74 23390001 */  addi       $t9, $t9, 0x1 /* handwritten instruction */
    /* 6F578 800B4D78 20A50001 */  addi       $a1, $a1, 0x1 /* handwritten instruction */
    /* 6F57C 800B4D7C 1000000D */  b          .L800B4DB4
    /* 6F580 800B4D80 A0AAFFFF */   sb        $t2, -0x1($a1)
    /* 6F584 800B4D84 94EA0000 */  lhu        $t2, 0x0($a3)
  .L800B4D88:
    /* 6F588 800B4D88 20E70002 */  addi       $a3, $a3, 0x2 /* handwritten instruction */
    /* 6F58C 800B4D8C 000A5B02 */  srl        $t3, $t2, 12
    /* 6F590 800B4D90 314A0FFF */  andi       $t2, $t2, 0xFFF
    /* 6F594 800B4D94 00AA4822 */  sub        $t1, $a1, $t2 /* handwritten instruction */
    /* 6F598 800B4D98 216B0003 */  addi       $t3, $t3, 0x3 /* handwritten instruction */
  .L800B4D9C:
    /* 6F59C 800B4D9C 812AFFFF */  lb         $t2, -0x1($t1)
    /* 6F5A0 800B4DA0 216BFFFF */  addi       $t3, $t3, -0x1 /* handwritten instruction */
    /* 6F5A4 800B4DA4 21290001 */  addi       $t1, $t1, 0x1 /* handwritten instruction */
    /* 6F5A8 800B4DA8 20A50001 */  addi       $a1, $a1, 0x1 /* handwritten instruction */
  ...
  .L800B4DB4:
    ...
    /* 6F5BC 800B4DBC 20C6FFFF */   addi      $a2, $a2, -0x1 /* handwritten instruction */
    /* 6F5C0 800B4DC0 03E00008 */  jr         $ra
    /* 6F5C4 800B4DC4 00000000 */   nop
.size func_800B4D30, . - func_800B4D30
