glabel func_800B2ABC
    ...
    /* 6D2EC 800B2AEC 3C0E8022 */  lui        $t6, %hi(D_A95D0_80223930)
    /* 6D2F0 800B2AF0 8DCE3930 */  lw         $t6, %lo(D_A95D0_80223930)($t6)
    /* 6D2F4 800B2AF4 3C01801D */  lui        $at, %hi(D_801D7B18)
    /* 6D2F8 800B2AF8 3C188022 */  lui        $t8, %hi(D_A95D0_80227C80)
    ...
    /* 6D314 800B2B14 27187C80 */  addiu      $t8, $t8, %lo(D_A95D0_80227C80)
    ...
    /* 6D354 800B2B54 0C07B6F5 */  jal        func_A95D0_801EDBD4
  ...
  .L800B2BA0:
    ...
    /* 6D3C0 800B2BC0 0C07B6B8 */  jal        func_A95D0_801EDAE0
    ...
    /* 6D40C 800B2C0C 0C07B6B8 */  jal        func_A95D0_801EDAE0
  ...
  .L800B2C68:
    ...
    /* 6D474 800B2C74 3C0E8022 */  lui        $t6, %hi(D_A95D0_80223934)
    /* 6D478 800B2C78 15A10057 */  bne        $t5, $at, .L800B2DD8
    /* 6D47C 800B2C7C 3C188022 */   lui       $t8, %hi(D_A95D0_80227C80)
    /* 6D480 800B2C80 8DCE3934 */  lw         $t6, %lo(D_A95D0_80223934)($t6)
    /* 6D484 800B2C84 27187C80 */  addiu      $t8, $t8, %lo(D_A95D0_80227C80)
    ...
    /* 6D4CC 800B2CCC 0C07B6F5 */  jal        func_A95D0_801EDBD4
  ...
  .L800B2D18:
    ...
    /* 6D538 800B2D38 0C07B6B8 */  jal        func_A95D0_801EDAE0
    ...
    /* 6D584 800B2D84 0C07B6B8 */  jal        func_A95D0_801EDAE0
  ...
  .L800B2E20:
    ...
    /* 6D650 800B2E50 3C088022 */  lui        $t0, %hi(D_A95D0_80223930)
    /* 6D654 800B2E54 13C20006 */  beq        $fp, $v0, .L800B2E70
    /* 6D658 800B2E58 3C0A8022 */   lui       $t2, %hi(D_A95D0_80227C80)
  ...
  .L800B2E70:
    /* 6D670 800B2E70 8D083930 */  lw         $t0, %lo(D_A95D0_80223930)($t0)
    /* 6D674 800B2E74 254A7C80 */  addiu      $t2, $t2, %lo(D_A95D0_80227C80)
    /* 6D678 800B2E78 3C0B8022 */  lui        $t3, %hi(D_A95D0_80223934)
    ...
    /* 6D698 800B2E98 8D6B3934 */  lw         $t3, %lo(D_A95D0_80223934)($t3)
    /* 6D69C 800B2E9C 3C0D8022 */  lui        $t5, %hi(D_A95D0_80227C80)
    /* 6D6A0 800B2EA0 25AD7C80 */  addiu      $t5, $t5, %lo(D_A95D0_80227C80)
  ...
  .L800B2EC0:
    /* 6D6C0 800B2EC0 3C0E8022 */  lui        $t6, %hi(D_A95D0_80223934)
    /* 6D6C4 800B2EC4 8DCE3934 */  lw         $t6, %lo(D_A95D0_80223934)($t6)
    /* 6D6C8 800B2EC8 3C188022 */  lui        $t8, %hi(D_A95D0_80227C80)
    /* 6D6CC 800B2ECC 27187C80 */  addiu      $t8, $t8, %lo(D_A95D0_80227C80)
    ...
    /* 6D6EC 800B2EEC 3C198022 */  lui        $t9, %hi(D_A95D0_80223930)
    /* 6D6F0 800B2EF0 8F393930 */  lw         $t9, %lo(D_A95D0_80223930)($t9)
    /* 6D6F4 800B2EF4 3C098022 */  lui        $t1, %hi(D_A95D0_80227C80)
    /* 6D6F8 800B2EF8 25297C80 */  addiu      $t1, $t1, %lo(D_A95D0_80227C80)
...
.size func_800B2ABC, . - func_800B2ABC
