glabel func_A95D0_801EBFE4
    ...
    /* BA674 801EC044 3C01800E */  lui        $at, %hi(gPlayers)
    /* BA678 801EC048 AC22AB28 */  sw         $v0, %lo(gPlayers)($at)
    /* BA67C 801EC04C 3C01800E */  lui        $at, %hi(gCourseID)
    /* BA680 801EC050 AC228170 */  sw         $v0, %lo(gCourseID)($at)
    /* BA684 801EC054 3C01801D */  lui        $at, %hi(gRiderGameModes)
    /* BA688 801EC058 AC22E648 */  sw         $v0, %lo(gRiderGameModes)($at)
