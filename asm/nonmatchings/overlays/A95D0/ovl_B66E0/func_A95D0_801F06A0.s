glabel func_A95D0_801F06A0
  ...
  .LA95D0_801F07AC:
    ...
    /* BEE74 801F0844 3C1E800E */  lui        $fp, %hi(gPlayers)
    /* BEE78 801F0848 27DEAB28 */  addiu      $fp, $fp, %lo(gPlayers)
  ...
  .LA95D0_801F0B38:
    ...
    /* BF37C 801F0D4C 3C06800E */  lui        $a2, %hi(gPlayers)
    /* BF380 801F0D50 26B50001 */  addiu      $s5, $s5, 0x1
    /* BF384 801F0D54 ACAE0004 */  sw         $t6, 0x4($a1)
    /* BF388 801F0D58 8CC6AB28 */  lw         $a2, %lo(gPlayers)($a2)
  ...
  .LA95D0_801F0D6C:
    ...
    /* BF3B8 801F0D88 3C18800E */  lui        $t8, %hi(gPlayers)
    /* BF3BC 801F0D8C 8F18AB28 */  lw         $t8, %lo(gPlayers)($t8)
