glabel func_A95D0_801FC39C
    ...
    /* CA9E4 801FC3B4 3C0B801D */   lui       $t3, %hi(gGameModes)
  ...
  .LA95D0_801FC3EC:
    /* CAA1C 801FC3EC 8D6BE620 */  lw         $t3, %lo(gGameModes)($t3)
  ...
  .LA95D0_801FC468:
    /* CAA98 801FC468 3C03800E */  lui        $v1, %hi(gPlayers)
    /* CAA9C 801FC46C 8C63AB28 */  lw         $v1, %lo(gPlayers)($v1)
