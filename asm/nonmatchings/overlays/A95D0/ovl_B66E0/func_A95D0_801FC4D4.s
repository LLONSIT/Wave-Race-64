glabel func_A95D0_801FC4D4
  ...
  .LA95D0_801FC504:
    ...
    /* CAB70 801FC540 3C0D800E */  lui        $t5, %hi(gPlayers)
    ...
    /* CAB84 801FC554 8DADAB28 */  lw         $t5, %lo(gPlayers)($t5)
  ...
  .LA95D0_801FC5FC:
    /* CAC2C 801FC5FC 3C02801D */  lui        $v0, %hi(gGameModes)
    /* CAC30 801FC600 8C42E620 */  lw         $v0, %lo(gGameModes)($v0)
  ...
  .LA95D0_801FC614:
    ...
    /* CAC50 801FC620 3C0A800E */  lui        $t2, %hi(gCourseID)
    /* CAC54 801FC624 1521000A */  bne        $t1, $at, .LA95D0_801FC650
    /* CAC58 801FC628 00000000 */   nop
    /* CAC5C 801FC62C 8D4A8170 */  lw         $t2, %lo(gCourseID)($t2)
  ...
  .LA95D0_801FC670:
    ...
    /* CACB8 801FC688 3C08800E */  lui        $t0, %hi(gPlayers)
    ...
    /* CACD0 801FC6A0 8D08AB28 */  lw         $t0, %lo(gPlayers)($t0)
  ...
  .LA95D0_801FC6D8:
    ...
    /* CAD38 801FC708 3C18800E */  lui        $t8, %hi(gPlayers)
    /* CAD3C 801FC70C 15E1000B */  bne        $t7, $at, .LA95D0_801FC73C
    /* CAD40 801FC710 00000000 */   nop
    /* CAD44 801FC714 8F18AB28 */  lw         $t8, %lo(gPlayers)($t8)
  ...
  .LA95D0_801FC73C:
    /* CAD6C 801FC73C 3C08801D */  lui        $t0, %hi(gGameModes)
    /* CAD70 801FC740 8D08E620 */  lw         $t0, %lo(gGameModes)($t0)
    /* CAD74 801FC744 2401000B */  addiu      $at, $zero, 0xB
    /* CAD78 801FC748 11010006 */  beq        $t0, $at, .LA95D0_801FC764
    /* CAD7C 801FC74C 3C09800E */   lui       $t1, %hi(gCourseID)
    /* CAD80 801FC750 8D298170 */  lw         $t1, %lo(gCourseID)($t1)
  ...
  .LA95D0_801FC764:
    ...
    /* CADB8 801FC788 3C0B801D */  lui        $t3, %hi(gGameModes)
    /* CADBC 801FC78C 8D6BE620 */  lw         $t3, %lo(gGameModes)($t3)
  ...
  .LA95D0_801FC7A4:
    ...
    /* CADDC 801FC7AC 3C02801D */  lui        $v0, %hi(gGameModes)
    /* CADE0 801FC7B0 8C42E620 */  lw         $v0, %lo(gGameModes)($v0)
  ...
  .LA95D0_801FC7C4:
    /* CADF4 801FC7C4 3C0C800E */   lui       $t4, %hi(gCourseID)
    /* CADF8 801FC7C8 8D8C8170 */  lw         $t4, %lo(gCourseID)($t4)
    ...
    /* CAE0C 801FC7DC 3C02801D */  lui        $v0, %hi(gGameModes)
    /* CAE10 801FC7E0 8C42E620 */  lw         $v0, %lo(gGameModes)($v0)
  .LA95D0_801FC7E4:
  ...
  .LA95D0_801FC7F8:
    /* CAE28 801FC7F8 3C0D800E */  lui        $t5, %hi(gPlayers)
    /* CAE2C 801FC7FC 8DADAB28 */  lw         $t5, %lo(gPlayers)($t5)
