glabel func_A95D0_801EBD28
    ...
    /* BA3C4 801EBD94 3C01801D */  lui        $at, %hi(gGameModes)
    /* BA3C8 801EBD98 AFBF001C */  sw         $ra, 0x1C($sp)
    /* BA3CC 801EBD9C 15380008 */  bne        $t1, $t8, .LA95D0_801EBDC0
    /* BA3D0 801EBDA0 AC20E620 */   sw        $zero, %lo(gGameModes)($at)
    /* BA3D4 801EBDA4 3C06800E */  lui        $a2, %hi(gPlayers)
    /* BA3D8 801EBDA8 24C6AB28 */  addiu      $a2, $a2, %lo(gPlayers)
    /* BA3DC 801EBDAC ACC90000 */  sw         $t1, 0x0($a2)
    /* BA3E0 801EBDB0 3C01801A */  lui        $at, %hi(gRiders)
    /* BA3E4 801EBDB4 AC2982F0 */  sw         $t1, %lo(gRiders)($at)
    /* BA3E8 801EBDB8 10000007 */  b          .LA95D0_801EBDD8
    /* BA3EC 801EBDBC 24080002 */   addiu     $t0, $zero, 0x2
  .LA95D0_801EBDC0:
    /* BA3F0 801EBDC0 3C06800E */  lui        $a2, %hi(gPlayers)
    /* BA3F4 801EBDC4 24C6AB28 */  addiu      $a2, $a2, %lo(gPlayers)
    /* BA3F8 801EBDC8 24080002 */  addiu      $t0, $zero, 0x2
    /* BA3FC 801EBDCC ACC80000 */  sw         $t0, 0x0($a2)
    /* BA400 801EBDD0 3C01801A */  lui        $at, %hi(gRiders)
    /* BA404 801EBDD4 AC2882F0 */  sw         $t0, %lo(gRiders)($at)
  .LA95D0_801EBDD8:
    ...
    /* BA42C 801EBDFC 3C01800E */  lui        $at, %hi(gCourseID)
    /* BA430 801EBE00 240E0009 */  addiu      $t6, $zero, 0x9
    /* BA434 801EBE04 11E00009 */  beqz       $t7, .LA95D0_801EBE2C
    /* BA438 801EBE08 AC2E8170 */   sw        $t6, %lo(gCourseID)($at)
  ...
  .LA95D0_801EBE2C:
    ...
    /* BA4AC 801EBE7C 3C01801D */  lui        $at, %hi(gRiderGameModes)
  ...
  .LA95D0_801EBEF8:
    /* BA528 801EBEF8 AC28E648 */  sw         $t0, %lo(gRiderGameModes)($at)
