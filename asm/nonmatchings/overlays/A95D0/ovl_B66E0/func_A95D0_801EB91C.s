glabel func_A95D0_801EB91C
    ...
    /* B9FB8 801EB988 3C01800E */  lui        $at, %hi(gPlayers)
    /* B9FBC 801EB98C AFBF001C */  sw         $ra, 0x1C($sp)
    /* B9FC0 801EB990 13200006 */  beqz       $t9, .LA95D0_801EB9AC
    /* B9FC4 801EB994 AC27AB28 */   sw        $a3, %lo(gPlayers)($at)
  ...
  .LA95D0_801EB9AC:
    /* B9FDC 801EB9AC 3C0D801D */  lui        $t5, %hi(gDifficulty)
    /* B9FE0 801EB9B0 3C0F801D */  lui        $t7, %hi(D_801CB334)
    /* B9FE4 801EB9B4 8DEFB334 */  lw         $t7, %lo(D_801CB334)($t7)
    /* B9FE8 801EB9B8 8DADB338 */  lw         $t5, %lo(gDifficulty)($t5)
    ...
    /* BA008 801EB9D8 3C0A800E */  lui        $t2, %hi(gCourseID)
    /* BA00C 801EB9DC 254A8170 */  addiu      $t2, $t2, %lo(gCourseID)
  ...
  .LA95D0_801EBA10:
    ...
    /* BA054 801EBA24 3C01801D */  lui        $at, %hi(gGameModes)
    /* BA058 801EBA28 AC2FE620 */  sw         $t7, %lo(gGameModes)($at)
    ...
    /* BA078 801EBA48 3C01801A */  lui        $at, %hi(gRiders)
    /* BA07C 801EBA4C 10000009 */  b          .LA95D0_801EBA74
    /* BA080 801EBA50 AC3982F0 */   sw        $t9, %lo(gRiders)($at)
  .LA95D0_801EBA54:
    ...
    /* BA090 801EBA60 3C01801A */  lui        $at, %hi(gRiders)
    /* BA094 801EBA64 10000003 */  b          .LA95D0_801EBA74
    /* BA098 801EBA68 AC2C82F0 */   sw        $t4, %lo(gRiders)($at)
  .LA95D0_801EBA6C:
    /* BA09C 801EBA6C 3C01801A */  lui        $at, %hi(gRiders)
    /* BA0A0 801EBA70 AC2782F0 */  sw         $a3, %lo(gRiders)($at)
  .LA95D0_801EBA74:
  ...
  .LA95D0_801EBA8C:
    /* BA0BC 801EBA8C 3C01801D */  lui        $at, %hi(gRiderGameModes)
    /* BA0C0 801EBA90 10000003 */  b          .LA95D0_801EBAA0
    /* BA0C4 801EBA94 AC27E648 */   sw        $a3, %lo(gRiderGameModes)($at)
  .LA95D0_801EBA98:
    /* BA0C8 801EBA98 3C01801D */  lui        $at, %hi(gRiderGameModes)
    /* BA0CC 801EBA9C AC2DE648 */  sw         $t5, %lo(gRiderGameModes)($at)
  .LA95D0_801EBAA0:
    ...
    /* BA128 801EBAF8 0C011F94 */  jal        rand
  ...
  .LA95D0_801EBB38:
    ...
    /* BA170 801EBB40 3C0D800E */  lui        $t5, %hi(gCourseID)
  ...
  .LA95D0_801EBB54:
    /* BA184 801EBB54 8DAD8170 */  lw         $t5, %lo(gCourseID)($t5)
  ...
  .LA95D0_801EBB98:
    ...
    /* BA1F8 801EBBC8 3C08800E */  lui        $t0, %hi(gCourseID)
    ...
    /* BA234 801EBC04 8D088170 */  lw         $t0, %lo(gCourseID)($t0)
  ...
  .LA95D0_801EBCF8:
    ...
    /* BA338 801EBD08 3C05800E */  lui        $a1, %hi(gCourseID)
    /* BA33C 801EBD0C 8CA58170 */  lw         $a1, %lo(gCourseID)($a1)
