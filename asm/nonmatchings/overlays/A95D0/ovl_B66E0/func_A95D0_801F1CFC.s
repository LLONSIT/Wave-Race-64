glabel func_A95D0_801F1CFC
    ...
    /* C0330 801F1D00 3C0E801D */  lui        $t6, %hi(gGameModes)
    /* C0334 801F1D04 8DCEE620 */  lw         $t6, %lo(gGameModes)($t6)
  ...
  .LA95D0_801F1DB8:
    /* C03E8 801F1DB8 3C03800E */  lui        $v1, %hi(gPlayers)
    /* C03EC 801F1DBC 8C63AB28 */  lw         $v1, %lo(gPlayers)($v1)
  ...
  .LA95D0_801F2014:
    /* C0644 801F2014 3C03800E */  lui        $v1, %hi(gPlayers)
    /* C0648 801F2018 8C63AB28 */  lw         $v1, %lo(gPlayers)($v1)
