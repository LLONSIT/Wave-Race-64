glabel func_A95D0_801EF504
    ...
    /* BDB38 801EF508 3C0E800E */  lui        $t6, %hi(gPlayers)
    /* BDB3C 801EF50C 8DCEAB28 */  lw         $t6, %lo(gPlayers)($t6)
  ...
  .LA95D0_801EFB6C:
    /* BE19C 801EFB6C 3C02801D */  lui        $v0, %hi(gGameModes)
    /* BE1A0 801EFB70 8C42E620 */  lw         $v0, %lo(gGameModes)($v0)
  ...
  .LA95D0_801EFC0C:
    ...
    /* BE27C 801EFC4C 3C02801D */  lui        $v0, %hi(gGameModes)
    /* BE280 801EFC50 AFAF0098 */  sw         $t7, 0x98($sp)
    /* BE284 801EFC54 10000010 */  b          .LA95D0_801EFC98
    /* BE288 801EFC58 8C42E620 */   lw        $v0, %lo(gGameModes)($v0)
  .LA95D0_801EFC5C:
  ...
  .LA95D0_801EFC80:
    ...
    /* BE2C0 801EFC90 3C02801D */  lui        $v0, %hi(gGameModes)
    /* BE2C4 801EFC94 8C42E620 */  lw         $v0, %lo(gGameModes)($v0)
  .LA95D0_801EFC98:
  ...
  .LA95D0_801EFCD8:
    ...
    /* BE30C 801EFCDC 3C0D800E */   lui       $t5, %hi(gCourseID)
    /* BE310 801EFCE0 8DAD8170 */  lw         $t5, %lo(gCourseID)($t5)
  ...
  .LA95D0_801EFCF0:
    ...
    /* BE32C 801EFCFC 3C0E800E */  lui        $t6, %hi(gCourseID)
    /* BE330 801EFD00 1300001B */  beqz       $t8, .LA95D0_801EFD70
    /* BE334 801EFD04 00000000 */   nop
    /* BE338 801EFD08 8DCE8170 */  lw         $t6, %lo(gCourseID)($t6)
  ...
  .LA95D0_801EFEA0:
    ...
    /* BE534 801EFF04 3C0D800E */   lui       $t5, %hi(gCourseID)
    /* BE538 801EFF08 8DAD8170 */  lw         $t5, %lo(gCourseID)($t5)
  ...
  .LA95D0_801EFF7C:
    /* BE5AC 801EFF7C 3C19800E */  lui        $t9, %hi(gPlayers)
    /* BE5B0 801EFF80 8F39AB28 */  lw         $t9, %lo(gPlayers)($t9)
