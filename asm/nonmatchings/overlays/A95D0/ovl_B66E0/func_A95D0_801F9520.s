glabel func_A95D0_801F9520
    ...
    /* C7B54 801F9524 3C05800E */  lui        $a1, %hi(gPlayers)
    /* C7B58 801F9528 24A5AB28 */  addiu      $a1, $a1, %lo(gPlayers)
  ...
  .LA95D0_801F95A4:
    ...
    /* C7BDC 801F95AC 3C04801A */  lui        $a0, %hi(gRiders)
    ...
    /* C7BFC 801F95CC 8C8482F0 */  lw         $a0, %lo(gRiders)($a0)
  ...
  .LA95D0_801F9A18:
    /* C8048 801F9A18 3C19800E */   lui       $t9, %hi(gPlayers)
    /* C804C 801F9A1C 8F39AB28 */  lw         $t9, %lo(gPlayers)($t9)
  ...
  .LA95D0_801F9D18:
    ...
    /* C8458 801F9E28 3C04801A */  lui        $a0, %hi(gRiders)
    /* C845C 801F9E2C AC790004 */  sw         $t9, 0x4($v1)
    /* C8460 801F9E30 AC740000 */  sw         $s4, 0x0($v1)
    /* C8464 801F9E34 8C8482F0 */  lw         $a0, %lo(gRiders)($a0)
    ...
    /* C847C 801F9E4C 3C03800E */  lui        $v1, %hi(gPlayers)
    /* C8480 801F9E50 8C63AB28 */  lw         $v1, %lo(gPlayers)($v1)
