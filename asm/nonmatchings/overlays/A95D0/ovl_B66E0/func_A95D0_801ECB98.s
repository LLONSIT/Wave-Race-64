glabel func_A95D0_801ECB98
    ...
    /* BB228 801ECBF8 3C01801D */  lui        $at, %hi(gGameModes)
    /* BB22C 801ECBFC AC20E620 */  sw         $zero, %lo(gGameModes)($at)
    /* BB230 801ECC00 3C01800E */  lui        $at, %hi(gPlayers)
    /* BB234 801ECC04 AC22AB28 */  sw         $v0, %lo(gPlayers)($at)
    /* BB238 801ECC08 3C01801A */  lui        $at, %hi(gRiders)
    /* BB23C 801ECC0C 24190004 */  addiu      $t9, $zero, 0x4
    /* BB240 801ECC10 AC3982F0 */  sw         $t9, %lo(gRiders)($at)
    ...
    /* BB260 801ECC30 3C0C800E */  lui        $t4, %hi(gCourseID)
    /* BB264 801ECC34 AC23E728 */  sw         $v1, %lo(D_801CE728)($at)
    /* BB268 801ECC38 258C8170 */  addiu      $t4, $t4, %lo(gCourseID)
    ...
    /* BB27C 801ECC4C 3C01801D */  lui        $at, %hi(gRiderGameModes)
    ...
    /* BB28C 801ECC5C AC38E648 */  sw         $t8, %lo(gRiderGameModes)($at)
