glabel func_A95D0_801F9EA0
    ...
    /* C84D4 801F9EA4 3C0E800E */  lui        $t6, %hi(gPlayers)
    /* C84D8 801F9EA8 8DCEAB28 */  lw         $t6, %lo(gPlayers)($t6)
  ...
  .LA95D0_801F9F88:
    ...
    /* C860C 801F9FDC 3C02801A */  lui        $v0, %hi(gRiders)
    /* C8610 801F9FE0 8C4282F0 */  lw         $v0, %lo(gRiders)($v0)
  ...
  .LA95D0_801FA0D8:
    ...
    /* C871C 801FA0EC 3C02801A */  lui        $v0, %hi(gRiders)
  ...
  .LA95D0_801FA118:
    ...
    /* C874C 801FA11C 8C4282F0 */   lw        $v0, %lo(gRiders)($v0)
  ...
  .LA95D0_801FA320:
    ...
    /* C8958 801FA328 3C02801A */  lui        $v0, %hi(gRiders)
    ...
    /* C8974 801FA344 8C4282F0 */  lw         $v0, %lo(gRiders)($v0)
  .LA95D0_801FA348:
  ...
  .LA95D0_801FA358:
    ...
    /* C898C 801FA35C 3C0C800E */  lui        $t4, %hi(gPlayers)
    /* C8990 801FA360 8D8CAB28 */  lw         $t4, %lo(gPlayers)($t4)
