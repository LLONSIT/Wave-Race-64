glabel func_i0_802C6944
    ...
    /* 1B5018 802C6958 11C00002 */  beqz       $t6, .Li0_802C6964
  ...
  .Li0_802C6964:
    ...
    /* 1B5048 802C6988 3C088023 */  lui        $t0, %hi(D_80228A16)
    /* 1B504C 802C698C 85088A16 */  lh         $t0, %lo(D_80228A16)($t0)
    /* 1B5050 802C6990 24010001 */  addiu      $at, $zero, 0x1
    /* 1B5054 802C6994 3C02801D */  lui        $v0, %hi(D_801CE630)
    /* 1B5058 802C6998 5501001C */  bnel       $t0, $at, .Li0_802C6A0C
    ...
    /* 1B5068 802C69A8 10410011 */  beq        $v0, $at, .Li0_802C69F0
    /* 1B506C 802C69AC 24010007 */   addiu     $at, $zero, 0x7
    /* 1B5070 802C69B0 10410013 */  beq        $v0, $at, .Li0_802C6A00
    /* 1B5074 802C69B4 2401000A */   addiu     $at, $zero, 0xA
    /* 1B5078 802C69B8 10410005 */  beq        $v0, $at, .Li0_802C69D0
    /* 1B507C 802C69BC 2401003C */   addiu     $at, $zero, 0x3C
    /* 1B5080 802C69C0 10410007 */  beq        $v0, $at, .Li0_802C69E0
    /* 1B5084 802C69C4 00000000 */   nop
    /* 1B5088 802C69C8 10000010 */  b          .Li0_802C6A0C
    /* 1B508C 802C69CC 8FBF0014 */   lw        $ra, 0x14($sp)
  .Li0_802C69D0:
    /* 1B5090 802C69D0 0C07AF4A */  jal        func_801EBD28
    /* 1B5094 802C69D4 00000000 */   nop
    /* 1B5098 802C69D8 1000000C */  b          .Li0_802C6A0C
    /* 1B509C 802C69DC 8FBF0014 */   lw        $ra, 0x14($sp)
  .Li0_802C69E0:
    /* 1B50A0 802C69E0 0C07B0C1 */  jal        func_801EC304
    /* 1B50A4 802C69E4 00000000 */   nop
    /* 1B50A8 802C69E8 10000008 */  b          .Li0_802C6A0C
    /* 1B50AC 802C69EC 8FBF0014 */   lw        $ra, 0x14($sp)
  .Li0_802C69F0:
    /* 1B50B0 802C69F0 0C07AC60 */  jal        func_801EB180
    /* 1B50B4 802C69F4 00000000 */   nop
    /* 1B50B8 802C69F8 10000004 */  b          .Li0_802C6A0C
    /* 1B50BC 802C69FC 8FBF0014 */   lw        $ra, 0x14($sp)
  .Li0_802C6A00:
    /* 1B50C0 802C6A00 0C07AD3D */  jal        func_801EB4F4
