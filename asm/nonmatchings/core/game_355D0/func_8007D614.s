glabel func_8007D614
  ...
  .L8007D64C:
    ...
    /* 37E8C 8007D68C 3C01800F */  lui        $at, %hi(jtbl_800EA31C_main_segment)
    /* 37E90 8007D690 00380821 */  addu       $at, $at, $t8
    /* 37E94 8007D694 8C38A31C */  lw         $t8, %lo(jtbl_800EA31C_main_segment)($at)
  ...
  jlabel L8007D6A4
    ...
    /* 37EF8 8007D6F8 3C01800F */  lui        $at, %hi(jtbl_800EA334_main_segment)
    /* 37EFC 8007D6FC 002F0821 */  addu       $at, $at, $t7
    /* 37F00 8007D700 8C2FA334 */  lw         $t7, %lo(jtbl_800EA334_main_segment)($at)
  ...
  jlabel L8007D70C
    ...
    /* 37F54 8007D754 3C01800F */  lui        $at, %hi(jtbl_800EA348_main_segment)
    /* 37F58 8007D758 002F0821 */  addu       $at, $at, $t7
    /* 37F5C 8007D75C 8C2FA348 */  lw         $t7, %lo(jtbl_800EA348_main_segment)($at)
  ...
  .L8007D7FC:
    ...
    /* 38008 8007D808 3C01800F */  lui        $at, %hi(jtbl_800EA36C_main_segment)
    /* 3800C 8007D80C 002F0821 */  addu       $at, $at, $t7
    /* 38010 8007D810 8C2FA36C */  lw         $t7, %lo(jtbl_800EA36C_main_segment)($at)
  ...
  .L8007DAC0:
    ...
    /* 38308 8007DB08 3C01800F */  lui        $at, %hi(jtbl_800EA384_main_segment)
    /* 3830C 8007DB0C 002F0821 */  addu       $at, $at, $t7
    /* 38310 8007DB10 8C2FA384 */  lw         $t7, %lo(jtbl_800EA384_main_segment)($at)
...
.size func_8007D614, . - func_8007D614
