glabel func_8009C968
  ...
  .L8009CA98:
    /* 57298 8009CA98 3C02801D */  lui        $v0, %hi(D_801CE620)
    /* 5729C 8009CA9C 8C42E620 */  lw         $v0, %lo(D_801CE620)($v0)
    /* 572A0 8009CAA0 24010004 */  addiu      $at, $zero, 0x4
    /* 572A4 8009CAA4 3C09800E */  lui        $t1, %hi(D_800D8170)
    /* 572A8 8009CAA8 14410006 */  bne        $v0, $at, .L8009CAC4
    /* 572AC 8009CAAC 24030001 */   addiu     $v1, $zero, 0x1
    /* 572B0 8009CAB0 8D298170 */  lw         $t1, %lo(D_800D8170)($t1)
  ...
  .L8009CAC4:
    ...
    /* 572CC 8009CACC 3C0B800E */  lui        $t3, %hi(D_800D8170)
    /* 572D0 8009CAD0 8D6B8170 */  lw         $t3, %lo(D_800D8170)($t3)
  ...
  .L8009CAF0:
    ...
    /* 572F4 8009CAF4 3C0C801D */  lui        $t4, %hi(D_801CB338)
    ...
    /* 57318 8009CB18 8D8CB338 */  lw         $t4, %lo(D_801CB338)($t4)
...
.size func_8009C968, . - func_8009C968
