glabel func_1B3EC0_802C63AC
    ...
    /* 1B4A88 802C63C8 3C0C802C */  lui        $t4, %hi(D_1B3EC0_802C6E08)
    /* 1B4A8C 802C63CC 258C6E08 */  addiu      $t4, $t4, %lo(D_1B3EC0_802C6E08)
    ...
    /* 1B4AA0 802C63E0 3C05802C */  lui        $a1, %hi(D_1B3EC0_802C6BCC)
    ...
    /* 1B4AB4 802C63F4 130000BC */  beqz       $t8, .L1B3EC0_802C66E8
    /* 1B4AB8 802C63F8 AFAF001C */   sw        $t7, 0x1C($sp)
    /* 1B4ABC 802C63FC 24A56BCC */  addiu      $a1, $a1, %lo(D_1B3EC0_802C6BCC)
  ...
  .L1B3EC0_802C644C:
    ...
    /* 1B4B20 802C6460 54C10081 */  bnel       $a2, $at, .L1B3EC0_802C6668
    ...
    /* 1B4B3C 802C647C 3C03801D */  lui        $v1, %hi(D_801CB338)
    /* 1B4B40 802C6480 2463B338 */  addiu      $v1, $v1, %lo(D_801CB338)
    ...
    /* 1B4B6C 802C64AC 17210002 */  bne        $t9, $at, .L1B3EC0_802C64B8
  ...
  jlabel L1B3EC0_802C64E0
    ...
    /* 1B4BC4 802C6504 1000000F */  b          .L1B3EC0_802C6544
    /* 1B4BC8 802C6508 AC4F0010 */   sw        $t7, 0x10($v0)
  .L1B3EC0_802C650C:
    /* 1B4BCC 802C650C 15050007 */  bne        $t0, $a1, .L1B3EC0_802C652C
    ...
    /* 1B4BE4 802C6524 10000007 */  b          .L1B3EC0_802C6544
  ...
  .L1B3EC0_802C6560:
    ...
    /* 1B4C28 802C6568 1420FFFD */  bnez       $at, .L1B3EC0_802C6560
    ...
    /* 1B4C48 802C6588 15E10002 */  bne        $t7, $at, .L1B3EC0_802C6594
  ...
  jlabel L1B3EC0_802C6600
    ...
    /* 1B4CD0 802C6610 1000000C */  b          .L1B3EC0_802C6644
    /* 1B4CD4 802C6614 AC400014 */   sw        $zero, 0x14($v0)
  jlabel L1B3EC0_802C6618
    ...
    /* 1B4CF0 802C6630 10000004 */  b          .L1B3EC0_802C6644
    /* 1B4CF4 802C6634 AC400014 */   sw        $zero, 0x14($v0)
  jlabel L1B3EC0_802C6638
    /* 1B4CF8 802C6638 10000002 */  b          .L1B3EC0_802C6644
    /* 1B4CFC 802C663C 2406003C */   addiu     $a2, $zero, 0x3C
  jlabel L1B3EC0_802C6640
  ...
  .L1B3EC0_802C6648:
    ...
    /* 1B4D14 802C6654 0C0B1A87 */  jal        func_1B3EC0_802C6A1C
    /* 1B4D18 802C6658 8FA40018 */   lw        $a0, 0x18($sp)
    /* 1B4D1C 802C665C 10000068 */  b          .L1B3EC0_802C6800
  ...
  .L1B3EC0_802C6668:
    ...
    /* 1B4D38 802C6678 10680005 */  beq        $v1, $t0, .L1B3EC0_802C6690
    /* 1B4D3C 802C667C 3C18800E */   lui       $t8, %hi(D_800DAA00)
    /* 1B4D40 802C6680 10610008 */  beq        $v1, $at, .L1B3EC0_802C66A4
    /* 1B4D44 802C6684 3C0D802C */   lui       $t5, %hi(D_1B3EC0_802C6BC0)
    /* 1B4D48 802C6688 1000000C */  b          .L1B3EC0_802C66BC
    /* 1B4D4C 802C668C 8D2F0000 */   lw        $t7, 0x0($t1)
  .L1B3EC0_802C6690:
    /* 1B4D50 802C6690 8718AA00 */  lh         $t8, %lo(D_800DAA00)($t8)
    /* 1B4D54 802C6694 5B000009 */  blezl      $t8, .L1B3EC0_802C66BC
    /* 1B4D58 802C6698 8D2F0000 */   lw        $t7, 0x0($t1)
    /* 1B4D5C 802C669C 10000006 */  b          .L1B3EC0_802C66B8
    /* 1B4D60 802C66A0 ACE80000 */   sw        $t0, 0x0($a3)
  .L1B3EC0_802C66A4:
    /* 1B4D64 802C66A4 8DAD6BC0 */  lw         $t5, %lo(D_1B3EC0_802C6BC0)($t5)
    /* 1B4D68 802C66A8 240E0005 */  addiu      $t6, $zero, 0x5
    /* 1B4D6C 802C66AC 51A00003 */  beql       $t5, $zero, .L1B3EC0_802C66BC
    /* 1B4D70 802C66B0 8D2F0000 */   lw        $t7, 0x0($t1)
    /* 1B4D74 802C66B4 AD2E0000 */  sw         $t6, 0x0($t1)
  .L1B3EC0_802C66B8:
    /* 1B4D78 802C66B8 8D2F0000 */  lw         $t7, 0x0($t1)
  .L1B3EC0_802C66BC:
    /* 1B4D7C 802C66BC 3C01802C */  lui        $at, %hi(D_1B3EC0_802C6BD0)
    ...
    /* 1B4D9C 802C66DC AC386BD0 */   sw        $t8, %lo(D_1B3EC0_802C6BD0)($at)
    /* 1B4DA0 802C66E0 10000047 */  b          .L1B3EC0_802C6800
    /* 1B4DA4 802C66E4 8FB9001C */   lw        $t9, 0x1C($sp)
  .L1B3EC0_802C66E8:
    /* 1B4DA8 802C66E8 11A00020 */  beqz       $t5, .L1B3EC0_802C676C
    /* 1B4DAC 802C66EC 304F0800 */   andi      $t7, $v0, 0x800
    /* 1B4DB0 802C66F0 10800042 */  beqz       $a0, .L1B3EC0_802C67FC
    /* 1B4DB4 802C66F4 AFA0001C */   sw        $zero, 0x1C($sp)
    /* 1B4DB8 802C66F8 3C05802C */  lui        $a1, %hi(D_1B3EC0_802C6BCC)
    /* 1B4DBC 802C66FC 24A56BCC */  addiu      $a1, $a1, %lo(D_1B3EC0_802C6BCC)
    /* 1B4DC0 802C6700 8CA20000 */  lw         $v0, 0x0($a1)
    /* 1B4DC4 802C6704 3C0F802C */  lui        $t7, %hi(D_802C6EF8)
    /* 1B4DC8 802C6708 18400003 */  blez       $v0, .L1B3EC0_802C6718
  ...
  .L1B3EC0_802C6718:
    ...
    /* 1B4E04 802C6744 3C01802C */  lui        $at, %hi(D_1B3EC0_802C6BD0)
    ...
    /* 1B4E20 802C6760 AC2E6BD0 */   sw        $t6, %lo(D_1B3EC0_802C6BD0)($at)
    /* 1B4E24 802C6764 10000026 */  b          .L1B3EC0_802C6800
    /* 1B4E28 802C6768 8FB9001C */   lw        $t9, 0x1C($sp)
  .L1B3EC0_802C676C:
    /* 1B4E2C 802C676C 11E00012 */  beqz       $t7, .L1B3EC0_802C67B8
    ...
    /* 1B4E4C 802C678C 07010005 */  bgez       $t8, .L1B3EC0_802C67A4
  ...
  .L1B3EC0_802C67A4:
    ...
    /* 1B4E70 802C67B0 10000013 */  b          .L1B3EC0_802C6800
    /* 1B4E74 802C67B4 8FB9001C */   lw        $t9, 0x1C($sp)
  .L1B3EC0_802C67B8:
    /* 1B4E78 802C67B8 13200010 */  beqz       $t9, .L1B3EC0_802C67FC
    ...
    /* 1B4EA4 802C67E4 14200002 */  bnez       $at, .L1B3EC0_802C67F0
  ...
  .L1B3EC0_802C6800:
    ...
    /* 1B4EC4 802C6804 13200016 */  beqz       $t9, .L1B3EC0_802C6860
    ...
    /* 1B4ED8 802C6818 1700000A */  bnez       $t8, .L1B3EC0_802C6844
    /* 1B4EDC 802C681C 3C0D801D */   lui       $t5, %hi(D_801CE658)
    /* 1B4EE0 802C6820 95ADE658 */  lhu        $t5, %lo(D_801CE658)($t5)
    /* 1B4EE4 802C6824 55A00008 */  bnel       $t5, $zero, .L1B3EC0_802C6848
    ...
    /* 1B4EFC 802C683C 10000002 */  b          .L1B3EC0_802C6848
  ...
  .L1B3EC0_802C6848:
    ...
    /* 1B4F10 802C6850 14200003 */  bnez       $at, .L1B3EC0_802C6860
    /* 1B4F14 802C6854 00000000 */   nop
    /* 1B4F18 802C6858 0C0B1A87 */  jal        func_1B3EC0_802C6A1C
    /* 1B4F1C 802C685C 24040007 */   addiu     $a0, $zero, 0x7
  .L1B3EC0_802C6860:
    /* 1B4F20 802C6860 0C011F94 */  jal        func_80047E50
...
.size func_1B3EC0_802C63AC, . - func_1B3EC0_802C63AC
