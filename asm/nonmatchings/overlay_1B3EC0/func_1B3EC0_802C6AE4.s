glabel func_1B3EC0_802C6AE4
  ...
  .L1B3EC0_802C6B20:
    ...
    /* 1B51F8 802C6B38 1420000A */  bnez       $at, .L1B3EC0_802C6B64
    ...
    /* 1B5214 802C6B54 0C078FB8 */  jal        func_A95D0_801E3EE0
    /* 1B5218 802C6B58 24050003 */   addiu     $a1, $zero, 0x3
    /* 1B521C 802C6B5C 10000002 */  b          .L1B3EC0_802C6B68
    /* 1B5220 802C6B60 00409825 */   or        $s3, $v0, $zero
  .L1B3EC0_802C6B64:
    /* 1B5224 802C6B64 26520001 */  addiu      $s2, $s2, 0x1
  .L1B3EC0_802C6B68:
    /* 1B5228 802C6B68 26310001 */  addiu      $s1, $s1, 0x1
    /* 1B522C 802C6B6C 1635FFEC */  bne        $s1, $s5, .L1B3EC0_802C6B20
    /* 1B5230 802C6B70 2610000C */   addiu     $s0, $s0, 0xC
    /* 1B5234 802C6B74 16550006 */  bne        $s2, $s5, .L1B3EC0_802C6B90
    /* 1B5238 802C6B78 02601025 */   or        $v0, $s3, $zero
    /* 1B523C 802C6B7C 3C01802C */  lui        $at, %hi(D_1B3EC0_802C6BF0)
    /* 1B5240 802C6B80 240A0137 */  addiu      $t2, $zero, 0x137
    /* 1B5244 802C6B84 240B02BF */  addiu      $t3, $zero, 0x2BF
    /* 1B5248 802C6B88 AC2A6BF0 */  sw         $t2, %lo(D_1B3EC0_802C6BF0)($at)
    /* 1B524C 802C6B8C AC2B6BFC */  sw         $t3, %lo(D_1B3EC0_802C6BFC)($at)
  .L1B3EC0_802C6B90:
...
.size func_1B3EC0_802C6AE4, . - func_1B3EC0_802C6AE4
    /* 1B5274 802C6BB4 00000000 */  nop
    /* 1B5278 802C6BB8 00000000 */  nop
    /* 1B527C 802C6BBC 00000000 */  nop
  glabel D_1B3EC0_802C6BC0
    /* 1B5280 802C6BC0 00000000 */  nop
  glabel D_1B3EC0_802C6BC4
    /* 1B5284 802C6BC4 00000000 */  nop
  glabel D_1B3EC0_802C6BC8
    /* 1B5288 802C6BC8 00000000 */  nop
  glabel D_1B3EC0_802C6BCC
    /* 1B528C 802C6BCC 00000000 */  nop
