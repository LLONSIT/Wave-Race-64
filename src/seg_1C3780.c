...
Gfx* func_1C3780_802C58F4(Gfx* gDisplayListHead) {
    ...
    // Wtf
    return func_80094200(func_80094200(func_80094200(func_80094200(func_801E3EE0
        (func_801E3EE0(func_801E3EE0(func_801E3EE0(func_801E3EE0(func_801E946C
        (func_80094338(func_80094338(func_80094338(func_80094338(func_80094338
        (gDisplayListHead, 0, D_802C5D88 + 8, 0x1E, 0x108, 0x18), 0, D_802C5D8C + 8, 0x50, 0x108, 0x10), 0, D_802C5D8C + 8, 0x62, 0x108, 0x18), 2, D_802C5D88 + 8, 0x8C, 0x108, 0x18), 2,
        D_802C5D88 + 8, 0xA5, 0x108, 0x18), 0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF), 2, D_800DAA34[gCourseID], D_1C3780_802C5D30[gCourseID] + 
        D_802C5D88 + 0x38, 0x21, 0), 2, 0x1C, D_802C5D88 + 0x64, 0x90, 0), 1, 3, D_802C5D8C + 0x1C, 0x53, 0), 1, 0x3D, D_802C5D8C + 0x71, 0x53, 0), 1, 0x3C, D_802C5D8C + 0xD9, 0x53, 0), 2,
        D_801C26D4, D_802C5D8C + 0x10, 0x69), 2, D_801C26DC, D_802C5D8C + 0x71, 0x69), 2, D_801C26D8, D_802C5D8C + 0xCD, 0x69), 0, D_801C26D0,
        D_802C5D88 + 0x5C, 0xA7);
}
