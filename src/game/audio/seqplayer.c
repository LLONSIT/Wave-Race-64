...
#pragma GLOBAL_ASM("asm/nonmatchings/game/audio/seqplayer/func_800BCB34.s")
...
// In MK64 and SF64, this and the previous func are the same func. Investigate
#pragma GLOBAL_ASM("asm/nonmatchings/game/audio/seqplayer/AudioSeq_AudioListPopBack2.s")
