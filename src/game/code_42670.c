...
void func_80087E70(void) {
    ...
    D_801C3C58->unk2C = (s32) func_80088D94(D_801C3C50->unk44, 
        D_801C3C50->unk4C, 
        temp_f0, 
        temp_f2,
        ( D_801C3C54[D_801C3C58->unk8].unk78 * 256.0f) + 
        temp_f0, 
        ( D_801C3C54[D_801C3C58->unk8].unk7C * 256.0f) + 
        temp_f2);
    ...
    D_801C3C58->unk30 = (s32) 
        func_80088D94(D_801C3C50->unk44, 
        D_801C3C50->unk4C, 
        temp_fs1, 
        temp_fs2, 
    ...
    D_801C3C58->unk3C = func_80086C40(
        temp_fs1 = D_801C3C54[D_801C3C58->unk10].unk0, 
        temp_fs2 = D_801C3C54[D_801C3C58->unk10].unk8, 
        (D_801C3C54[D_801C3C58->unk10].unk70 * 256.0f) + temp_fs1, 
        (D_801C3C54[D_801C3C58->unk10].unk74 * 256.0f) + temp_fs2, 
        D_801C3C50->unk44,
        D_801C3C50->unk4C);
}
